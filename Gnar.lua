...
function Gnar_CastR(count, target)
	if Gnar_CountEnemiesNearUnit(myHero, 500) >= count and Ready(_R) and ValidTarget(target, 500) then if Config.R.RMode:Value() == 3 then Gnar_CastRToCollision() else DelayAction(function() Gnar_CastRToCollision() end, 0.350) end end
end
